...
CREATE TABLE `conversions` (
  ...
  KEY `user_id` (`user_id`),
  KEY `cart_id` (`cart_id`),
  CONSTRAINT `conversions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`ID`) ON DELETE CASCADE,
  CONSTRAINT `conversions_ibfk_2` FOREIGN KEY (`cart_id`) REFERENCES `abandoned_carts` (`id`) ON DELETE CASCADE
